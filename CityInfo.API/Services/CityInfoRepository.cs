...
namespace CityInfo.API.Services
{
    public class CityInfoRepository : ICityInfoRepository
    {
        ...
        public async Task<(IEnumerable<City>, PaginationMeteData)> GetCitiesAsync(string? name, string? searchQuery, int pageNumber, int pageSize)
        {
            ...
            var paginationMetadata = new PaginationMeteData(
